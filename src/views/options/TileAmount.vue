<template>
	<div class="container-fixed">
		<Card>
			...
			>How many pieces of each kind of tile would you like to have in your game?</p>
			<div class="container-fluid">
				<div class="tiles">
					<div v-for="(tile, i) of originalTiles" class="tile-container">
						<h6 class="text-center mb-0">{{tile.name}}</h6>
						<div class="cell">
							<Tile :tile="tile" />
							<fieldset class="amount">
								<button type="button" title="Down" class="sub" @click="updateAmount(i, -1)">-</button>
								<input type="number" name="quantity" pattern="[0-9]+" min="0" v-model="tile.amount" />

								<button type="button" title="Up" class="add" @click="updateAmount(i, 1)">+</button>
							</fieldset>
						</div>
					</div>
				</div>
