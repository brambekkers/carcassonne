<template>
	<div class="playerInput">
		...
		<div
			class="playerStats"
			v-else
			:class="{ currenPlayer: player.id === currentPlayer.id }"
		>
			<div class="background" />
...
export default {
	...
	methods: {
		...mapActions(["removePlayer", "changeColor", "changeType", "currentPlayer"]),
	},
	computed: {
		colorStyles() {
			return {
...
.currentPlayer {
	box-shadow: 0px 0px 10px 3px #fab13e, 0px 0px 50px 0px #fab13e;
}
</style>
