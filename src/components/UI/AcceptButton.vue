<template>
	<div id="tilesInfoContainer">
		...
		<div id="smallRoundContainer" :class="{show : nextTilePlaced}">
	...
	#tilesInfoContainer {
		...
		#smallRoundContainer {
			...
			#ghostButton {
				border-radius: 50%;
				box-shadow: 0 1px 2px #fff, 4px -1px 2px rgb(0 0 0 / 40%),
					inset 0 -5px 1px rgb(0 0 0 / 50%),
					inset 0 7px 2px rgb(255 255 255 / 51%),
					inset 0 0 18px 0 rgb(255 255 255 / 40%),
					inset 0 0 24px 0 rgb(0 0 0 / 40%), inset 0 0 36px 6px rgb(0 0 0 / 5%),
					inset 7px 0px 10px 0 rgb(0 0 0 / 25%);
				display: flex;
				justify-content: center;
				align-items: center;
